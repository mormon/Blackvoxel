                ...
                do
                  {
                    ...
                    switch (Screen_ChooseOption.ResultCode)
                      {
                      case ZScreen_ChooseOption::CHOICE_DISPLAY:
                        {
                          ZScreen_Options_Display Screen_Options_Display;
                          Screen_Options_Display.ProcessScreen (&GameEnv);
                          break;
                        }
                      case ZScreen_ChooseOption::CHOICE_SOUND:
                        {
                          ZScreen_Options_Sound Screen_Options_Sound;
                          Screen_Options_Sound.ProcessScreen (&GameEnv);
                          break;
                        }
                      case ZScreen_ChooseOption::CHOICE_MOUSE:
                        {
                          ZScreen_Options_Game Screen_Options_Mouse;
                          Screen_Options_Mouse.ProcessScreen (&GameEnv);
                          break;
                        }
                      case ZScreen_ChooseOption::CHOICE_KEYMAP:
                        {
                          ZScreen_Options_Keymap Screen_Options_Keymap;
                          Screen_Options_Keymap.ProcessScreen (&GameEnv);
                          break;
                        }
                      }
                  }
                while (Screen_ChooseOption.ResultCode !=
                       ZScreen_ChooseOption::CHOICE_QUIT);
              }
              break;
      ...
      if (StartGame)
        {
          ...
          if (!GameEnv.Start_Game ())
            {
              printf ("Start Game Failled\n");
              exit (0);
            }
          ...
          GameEnv.GameEventSequencer->SetGameTime (GameEnv.PhysicEngine->
                                                   GetSelectedActor ()->
                                                   Time_TotalGameTime);
...
//            Time_Start = SDL_GetTicks();
              ...
              GameEnv.VoxelProcessor->SetPlayerPosition (Actor->Location.x,
                                                         Actor->Location.y,
                                                         Actor->Location.z);
              ...
              GameEnv.GameWindow_Advertising->
                Advertising_Actions ((double) FrameTime);
              ...
              GameEnv.GameEventSequencer->ProcessEvents (GameEnv.
                                                         PhysicEngine->
                                                         GetSelectedActor ()->
                                                         Time_TotalGameTime);
              ...
              if (GameEnv.Time_GameLoop > 64.0)
                GameEnv.Time_GameLoop = 64.0;   // Game cannot make too long frames because inaccuracy. In this case, game must slow down.
